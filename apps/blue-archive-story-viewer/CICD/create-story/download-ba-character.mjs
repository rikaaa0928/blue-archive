...
function printUsage() {
  console.log(`Usage:
  node ./CICD/create-story/download-ba-character.mjs <character-name> [options]
  node ./CICD/create-story/download-ba-character.mjs --list
...
function searchCharacter(characters, keyword) {
...
async function fetchContentJson(contentId) {
...
function extractVoiceLines(baseData) {
